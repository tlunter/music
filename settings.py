...
STATICFILES_DIRS = (
    ...
    # Don't forget to use absolute paths, not orelative paths.
    os.path.join(ROOT_PATH,'app','static'),
)
...
MUSIC_FOLDER                   = '/home/tlunter/Music/'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'db_file_handler': {
            ...
            'filename': os.path.join(ROOT_PATH,'db.txt')
        },
    },
    'loggers': {
        'django.request': {
