...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchCount'
        db.create_table('app_searchcount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('track_count', self.gf('django.db.models.fields.IntegerField')()),
            ('average_score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('app', ['SearchCount'])

    def backwards(self, orm):
        # Deleting model 'SearchCount'
        db.delete_table('app_searchcount')
    ...
    models = {
        ...
        'app.searchcount': {
            'Meta': {'object_name': 'SearchCount'},
            'average_score': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'track_count': ('django.db.models.fields.IntegerField', [], {})
        },
        'app.setting': {
