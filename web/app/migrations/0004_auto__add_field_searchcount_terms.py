...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchCount.terms'
        db.add_column('app_searchcount', 'terms',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SearchCount.terms'
        db.delete_column('app_searchcount', 'terms')
    ...
    models = {
        ...
        'app.searchcount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'terms': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
